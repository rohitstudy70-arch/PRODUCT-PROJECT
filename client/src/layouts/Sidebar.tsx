  ...
  return (
    ...
    >
        ...
        <div className="p-3 space-y-1.5 overflow-y-auto max-h-[calc(100vh-140px)]">
          {filteredItems.map((item) => (
            ...
            >
              ...
              {!sidebarOpen && (
                <div className="absolute left-16 bg-slate-950 text-slate-100 border border-slate-850 px-2 py-1 text-xs rounded opacity-0 pointer-events-none group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-xl">
                  {item.label}
                </div>
              )}
            </NavLink>
      ...
      <div className="p-3 border-t border-slate-800/80 space-y-2">
        {sidebarOpen && user && (
          <div className="flex items-center space-x-3 p-2 bg-slate-950/40 rounded-lg border border-slate-800/50">
